...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh=new B("vimeo-player",{id:236203659,width:640}),ep=((a=J)&&a.__esModule?a.default:a)(e=>{localStorage.setItem("videoplayer-current-time",e.seconds)},1e3);eh.on("timeupdate",ep),eh.setCurrentTime(localStorage.getItem("videoplayer-current-time"));//# sourceMappingURL=02-video.8196d4e7.js.map

//# sourceMappingURL=02-video.8196d4e7.js.map
