 ...
 */var S=function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"addEventListener",o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:"removeEventListener",i="string"==typeof t?[t]:t;return i.forEach(function(t){e[r](t,n)}),{cancel:function(){return i.forEach(function(t){return e[o](t,n)})}}},M=void 0!==Array.prototype.indexOf,F="undefined"!=typeof window&&void 0!==window.postMessage;if(!T&&(!M||!F))throw Error("Sorry, the Vimeo Player API is not available in this browser.");var C="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==u?u:"undefined"!=typeof self?self:{};!/*!
...
}),A(this,"event:".concat(e),t)}},{key:"off",value:function(e,t){if(!e)throw TypeError("You must pass an event name.");if(t&&"function"!=typeof t)throw TypeError("The callback must be a function.");I(this,"event:".concat(e),t)&&this.callMethod("removeEventListener",e).catch(function(e){// Ignore the error. There will be an error event fired that
// will trigger the error callback if they are listening.
 ...
 * @param {HTMLElement} [parent=document] The parent element.
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;window.VimeoPlayerResizeEmbeds_||(window.VimeoPlayerResizeEmbeds_=!0,window.addEventListener("message",function(t){if(j(t.origin)&&t.data&&"spacechange"===t.data.event){for(var n=e.querySelectorAll("iframe"),r=0;r<n.length;r++)if(n[r].contentWindow===t.source){n[r].parentElement.style.paddingBottom="".concat(t.data.data[0].bottom,"px");break}}}))}(),/**
 * Add chapters to existing metadata for Google SEO
 *
 * @param {HTMLElement} [parent=document] The parent element.
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;window.VimeoSeoMetadataAppended||(window.VimeoSeoMetadataAppended=!0,window.addEventListener("message",function(t){if(j(t.origin)){var n=q(t.data);if(n&&"ready"===n.event)for(var r=e.querySelectorAll("iframe"),o=0;o<r.length;o++){var i=r[o],a=i.contentWindow===t.source;O(i.src)&&a&&new B(i).callMethod("appendVideoMetadata",window.location.href)}}}))}(),/**
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};let eh="videoplayer-current-time",ep=document.querySelector("iframe"),ev=new B(ep,{loop:!0,fullscreen:!0,quality:"1080p"});ev.on("timeupdate",((a=J)&&a.__esModule?a.default:a)(function(e){let t=e.seconds;localStorage.setItem(eh,JSON.stringify(t))},1e3)),ev.setCurrentTime(JSON.parse(localStorage.getItem(eh))||0),ev.setColor("#d8e0ff").then(function(e){console.log("The new color value: #D8E0FF")}).catch(function(e){console.log("An error occurred while setting the color")})}();//# sourceMappingURL=02-video.565a05d6.js.map

//# sourceMappingURL=02-video.565a05d6.js.map
