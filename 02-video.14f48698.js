...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};let eh=document.getElementById("vimeo-player-container"),ep=new Q(eh,{url:"https://player.vimeo.com/video/236203659",autoplay:!0}),ev=((a=J)&&a.__esModule?a.default:a)(async()=>{try{let e=await ep.getCurrentTime();localStorage.setItem("videoplayer-current-time",e)}catch(e){console.error("Error saving current time:",e)}},1e3);ep.on("timeupdate",ev),window.addEventListener("load",async()=>{let e=localStorage.getItem("videoplayer-current-time");if(e)try{await ep.setCurrentTime(parseFloat(e))}catch(e){console.error("Error setting current time:",e)}})}();//# sourceMappingURL=02-video.14f48698.js.map

//# sourceMappingURL=02-video.14f48698.js.map
